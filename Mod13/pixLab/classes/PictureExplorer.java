...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
	...
	private void setUpNextAndPreviousButtons() {
		...
		Icon prevIcon = new ImageIcon(DigitalPicture.class.getResource("pixLab/classes/leftArrow.gif"), "previous index");
		Icon nextIcon = new ImageIcon(DigitalPicture.class.getResource("pixLab/classes/rightArrow.gif"), "next index");
	...
	public static void main(String args[]) {
		...
		caterpillar.explore();
		Picture test = new Picture("pixLab/images/Sandwich.gif");
		test.explore();
	}
